...
function KontaktpersonInvitePage() {
  ...
  return (
    <InviteShell>
      ...
      <p className="mt-2 text-sm text-muted-foreground">
        Invitationen indeholder ikke timeseddeldata og giver ikke adgang alene. Du skal logge ind
        med den serververificerede Supabase-session eller det personlige magic link fra Sub-Z, før
        timesedlen kan godkendes.
      </p>
    </InviteShell>
  );
}
